...
const Checkout = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let text = "";
    text += "Order %0A %0A";
    text += `Full Name: ${letterCapitalize(user.fname)} ${letterCapitalize(
      user.lname
    )} %0A`;
      ...
      <section className="bg-white w-full py-[120px]">
        <div className="container grid grid-cols-2 gap-[22px] max-[800px]:grid-cols-1">
          <form
            ...
            className="p-[30px] gap-5 flex flex-col"
          >
            ...
            <div className="flex justify-between items-center gap-3 max-[1070px]:flex-col max-[1070px]:items-baseline">
              <label className="flex flex-col gap-2" htmlFor="fname">
                ...
                <input
                  ...
                  className="py-[10px] indent-3 focus:border-blue-500 border-[1px] border-slate-300 outline-none shadow-md focus:shadow-none text-[18px] rounded-[5px]"
                  id="fname"
                  type="text"
            ...
            <label className="flex flex-col gap-2" htmlFor="companyName">
              ...
              <input
                ...
                className="py-[15px] indent-3 focus:border-blue-500 border-[1px] border-slate-300 outline-none shadow-md focus:shadow-none text-[18px] rounded-[5px]"
                id="companyName"
                type="text"
          ...
          <div className="sticky">
            <div className="flex flex-col px-[30px] sticky top-[100px] py-[20px]">
              <div className="flex justify-between items-end border-b border-[#D9D9D9] pb-[40px]">
                ...
                <div className="flex flex-col gap-[15px]">
                  ...
                  <h2 className="text-[24px] text-[#B88E2F] font-bold">
                    Rs.
                    {cart
                      .reduce(
                        (sum, item) => sum + item.price * item.quantity,
              ...
              <div className="flex flex-col py-5">
                ...
                {paymentMethod === "cashOnDelivery" && (
                  <p className="text-[#9F9F9F]">Pay with cash upon delivery.</p>
                )}
              </div>
              ...
              <div className="flex justify-center">
                <button
                  onClick={handleOrder}
                  className="py-4 px-[100px] border rounded-[15px] mt-5 duration-200 hover:text-white hover:bg-[#B88E2F] hover:cursor-pointer"
                >
                  Place order
                </button>
              </div>
