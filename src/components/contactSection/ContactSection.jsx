...
const ContactSection = () => {
  return (
    <div className="flex items-center flex-col md:grid-cols-2 gap-10 py-16">
      <div className="flex items-center max-w-[700px] text-center gap-8 py-[20px] flex-col">
      ...
      <div className="flex gap-10 max-[850px]:flex-col py-[80px] px-[20px] justify-between">
        ...
        <div className="space-y-5 max-w-[500px]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <textarea
              ...
              className="w-full border border-gray-300 px-4 py-3 rounded h-32 resize-none"
            ></textarea>
          </div>
          <button className="bg-[#B88E2F] hover:bg-yellow-500 text-white font-semibold px-[60px] py-[10px] rounded">
            Submit
          </button>
        </div>
      </div>
